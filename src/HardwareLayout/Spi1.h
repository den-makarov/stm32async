...
/**
 * @brief Wrapper class for SPI1 module.
 *
 * Implementation shall provide wrappers for SPI1 clock enable/disable macros,
 * and platform-dependent functions remapPins() and unremapPins();
 */
class Spi1 : public HardwareLayout::Spi
{
public:
    explicit Spi1 (HardwareLayout::Port & _sclkPort, uint32_t _sclkPin,
        ...
        Spi { 1, SPI1, _sclkPort, _sclkPin, _mosiPort, _mosiPin, _misoPort, _misoPin, _remapped,
    ...
    virtual void remapPins (GPIO_InitTypeDef & gpioParameters) const
    {
        ...
        {
            #if defined(STM32F4)
                gpioParameters.Alternate = GPIO_AF5_SPI1;
