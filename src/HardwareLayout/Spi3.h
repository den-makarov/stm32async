...
#ifndef HARDWARE_LAYOUT_SPI3_H_
#define HARDWARE_LAYOUT_SPI3_H_
...
/**
 * @brief Wrapper class for SPI3 module.
 *
 * Implementation shall provide wrappers for SPI3 clock enable/disable macros,
 * and platform-dependent functions remapPins() and unremapPins();
 */
class Spi3 : public HardwareLayout::Spi
{
public:
    explicit Spi3 (HardwareLayout::Port & _sclkPort, uint32_t _sclkPin,
        ...
        Spi { 3, SPI3, _sclkPort, _sclkPin, _mosiPort, _mosiPin, _misoPort, _misoPin, _remapped,
    ...
    virtual void remapPins (GPIO_InitTypeDef & gpioParameters) const
    {
        ...
        {
            #if defined(STM32F4)
                gpioParameters.Alternate = GPIO_AF6_SPI3;
